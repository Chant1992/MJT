...
{
   return [GJGCChatContentEmojiParser setupWithString:string withPhoneNumbers:phoneNumberArray withLinkArray:linkArray andEmojis:emojiArray foregroundColor:black_color];
}
